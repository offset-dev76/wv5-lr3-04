...
const UnifiedHeader: React.FC<UnifiedHeaderProps> = ({ 
  ...
  const navItems: NavItem[] = [
    ...
    { name: 'Apps', path: '/apps', type: 'nav' },
    { name: 'Restaurant', path: '/restaurant', type: 'nav' },
  ];

  const allItems: HeaderItem[] = [
    ...navItems,
    { name: getCurrentTime(), type: 'time' },
  ...
  return (
    <div className="flex justify-center w-full p-6 md:p-8">
      <div className="bg-black/30 backdrop-blur-md border border-white/10 rounded-full px-6 py-3 shadow-2xl">
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${(isActive || isFocused)
                      ? 'bg-white/20 text-white shadow-lg text-shadow-glow' 
